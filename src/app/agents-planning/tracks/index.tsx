import jsx, { Css, If, Fragment } from "@xania/glow.js";
...
import { fullName, Position, Track } from "../services/planning";
import "./style.scss";
...
export default function TracksPlanning(props: PlanningProps): RouterComponent {
  return {
    async view() {
      return (
        <Fragment>
          <header style="display: flex; gap: 12px;">Planning Per Track</header>
          <main>
            <TimeTable
              label="Agent"
    ...
    return (
      ...
      >
        <div class="pos">
          ...
          <span class="delta" ngIf="c.delta" class_overflow="c.delta > 0">
            0
          </span>
...
async function getRows(
  ...
  const trackGroups: Group<Track>[] = groupBy(tracks, (e) => e.groupingTrackId);
